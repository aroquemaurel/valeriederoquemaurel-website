...
class CategoryModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self._service_photos = ServicePhotos(self._all_photos)

    def test_get_previous_photos_middle(self):
        previous_photos = self._service_photos.get_previous_photos(self._all_photos[5])
    ...
    def test_get_next_photos_middle(self):
        next_photos = self._service_photos.get_next_photos(self._all_photos[5])
    ...
    def test_get_previous_photos_first_photo(self):
        previous_photos = self._service_photos.get_previous_photos(self._all_photos[0])
        self.assertEqual(Config.NB_ELEMENTS_AROUND_PHOTO, len(previous_photos))
    ...
    def test_get_next_photos_last_photo(self):
        next_photos = self._service_photos.get_next_photos(self._all_photos[9])
        self.assertEqual(Config.NB_ELEMENTS_AROUND_PHOTO, len(next_photos))
    ...
    def test_get_next_previous_last_photo(self):
        ...
        previous_photos = self._service_photos.get_previous_photos(self._all_photos[9])
        self.assertEqual(Config.NB_ELEMENTS_AROUND_PHOTO, len(previous_photos))
    ...
    def test_get_next_previous_photos_first_photo(self):
        ...
        next_photos = self._service_photos.get_next_photos(self._all_photos[0])
        self.assertEqual(Config.NB_ELEMENTS_AROUND_PHOTO, len(next_photos))
    ...
    def test_get_previous_photos_second_photo(self):
        previous_photos = self._service_photos.get_previous_photos(self._all_photos[1])
        self.assertEqual(Config.NB_ELEMENTS_AROUND_PHOTO, len(previous_photos))
    ...
    def test_get_next_photos_almost_last_photo(self):
        next_photos = self._service_photos.get_next_photos(self._all_photos[8])
        self.assertEqual(Config.NB_ELEMENTS_AROUND_PHOTO, len(next_photos))
    ...
    def test_get_next_photos_few_photos(self):
        ...
        next_photos = self._service_photos.get_next_photos(self._all_photos[1])
    ...
    def test_get_previous_photos_no_photos(self):
        ...
        previous_photos = self._service_photos.get_previous_photos(None)
    ...
    def test_get_next_photos_no_photos(self):
        ...
        self._service_photos = ServicePhotos(self._all_photos)
        self._all_photos.append(self._create_photo(1, self._category))
        next_photos = self._service_photos.get_next_photos(None)
        self.assertEqual(0, len(next_photos))

    def test_get_next_photos_wrong_photo(self):
        next_photos = self._service_photos.get_next_photos(self._create_photo(1, self._category))
        self.assertEqual(0, len(next_photos))

    def test_get_previous_photos_wrong_photo(self):
        previous_photos = self._service_photos.get_previous_photos(self._create_photo(1, self._category))
        self.assertEqual(0, len(previous_photos))
